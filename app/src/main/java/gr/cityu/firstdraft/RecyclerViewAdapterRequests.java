...
public class RecyclerViewAdapterRequests extends FirebaseRecyclerAdapter<ItemUploadModel, RecyclerViewAdapterRequests.myViewHolder>{

    //variable to hold the interface
    private final RecyclerViewInterfaceRequests recyclerViewInterfaceRequests;
    private FirebaseRecyclerAdapter firebaseRecyclerAdapter;

    public RecyclerViewAdapterRequests(@NonNull FirebaseRecyclerOptions<ItemUploadModel> options, RecyclerViewInterfaceRequests recyclerViewInterfaceRequests) {
        super(options);
        this.recyclerViewInterfaceRequests = recyclerViewInterfaceRequests;
    ...
    public static class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView,RecyclerViewInterfaceRequests recyclerViewInterfaceRequests) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (recyclerViewInterfaceRequests != null ){
                        int pos = getAbsoluteAdapterPosition();
                        String id = posKeyList.get(pos);

                        if (pos != RecyclerView.NO_POSITION){
                            recyclerViewInterfaceRequests.onItemClick(id, pos);
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType ) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_row_request,parent,false);

        return new myViewHolder(view, recyclerViewInterfaceRequests);
    }
}
